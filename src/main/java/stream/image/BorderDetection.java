...
public class BorderDetection extends AbstractImageProcessor {
	...
	/**
	 * @param output The name/key of the output image is stored. If this name equals the name of the input image, the input image is going to be overwritten.
	 */
	...
	public Data process(Data item, ImageRGB img) {
		...
		ImageRGB borderimage = null;

		if (imageKey.equals(output)) {
			borderimage = img;
		} else {
			borderimage = new ImageRGB(img.getWidth(), img.getHeight());
		}
